      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-[var(--border-default)]">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-sm font-medium text-[var(--brand-500)] hover:text-[var(--brand-600)]">
              Forgot password?
            </Link>
          </div>
          ...
          >
            {loading ? (
              <LoadingSpinner size="md" color="white" text="Signing in..." />
            ) : (
              <>
        ...
        <p className="mt-4 text-center text-sm text-[var(--text-secondary)]">
          ...
          <Link to="/signup" className="font-medium text-[var(--brand-500)] hover:text-[var(--brand-600)]">
            Sign up
          </Link>
        </p>
      </div>
